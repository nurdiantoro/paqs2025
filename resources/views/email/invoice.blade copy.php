        ...
        <table width="100%" cellspacing="0" cellpadding="0" class="es-wrapper" role="none"
            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                    <table cellpadding="0" cellspacing="0" align="center" class="g" role="none"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" align="center" cellpadding="0" cellspacing="0" class="z"
                                    role="none"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                                    <tr>
                                        <td align="left" bgcolor="#f5f4f4"
                                            style="Margin:0;padding-top:30px;padding-right:20px;padding-bottom:30px;padding-left:20px;background-color:#f5f4f4">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://fucplnq.stripocdn.email/content/guids/CABINET_e5ab44e0288f85220a29ebb5af733c22898970d9993ccdb7be3fb398606965f5/images/logo_paqs_congress.png"
                                                                        alt="" width="100" class="adapt-img"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="bd bc"
                                                                    style="Margin:0;padding-top:5px;padding-right:40px;padding-bottom:5px;padding-left:40px">
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Thank you for registering for the PAQS Congress
                                                                        2025. Attached to this email, you will find the
                                                                        invoice with the number <strong>[Invoice
                                                                            Number]</strong> for your participation in
                                                                        the event. Kindly complete the payment to
                                                                        confirm your registration. Payment details are
                                                                        included in the invoice for your convenience.
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        We look forward to welcoming you to the PAQS
                                                                        Congress 2025.</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <span class="r"
                                                                        style="border-style:solid;border-color:#2CB543;background:#ff007a;border-width:0px;display:inline-block;border-radius:6px;width:auto"><a
                                                                            href="http://127.0.0.1:8000/invoice"
                                                                            target="_blank" class="n"
                                                                            style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:#ff007a;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #ff007a;padding-left:30px;padding-right:30px">Upload
                                                                            Payment</a></span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" align="center" class="i" role="none"
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table align="center" cellpadding="0" cellspacing="0" class="y"
